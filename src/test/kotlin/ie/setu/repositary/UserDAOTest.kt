...
class UserDAOTest {
    ...
    inner class ReadUsers {
        @Test
        fun `get all users from populated table`() {
            transaction {
        ...
        @Test
        fun `get user by id that doesn't exist`() {
            transaction {
        ...
        @Test
        fun `get user by id that exists`() {
            transaction {
                //Arrange - create and populate table with three users
        ...
        @Test
        fun `get all users over empty table`() {
            transaction {
        ...
        @Test
        fun `get user by email that doesn't exist`() {
            transaction {
        ...
        @Test
        fun `get user by email that exists`() {
            transaction {
